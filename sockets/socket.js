      ...
      try {
        ...
        if (intakeStatus === INTAKE_STATUS.IN_PROGRESS && currentStep) {
          ...
          if (result.intakeStatus === INTAKE_STATUS.COMPLETE) {
            ...
            await createMessage({
              sessionId,
              messageText: 'Thank you! I have all the information I need. Your support ticket has been created and is ready for submission.',
              sender: 'system'
            });

            socket.emit('message_response', {
              message: 'Thank you! I have all the information I need. Your support ticket has been created and is ready for submission.',
              timestamp: new Date().toISOString(),
              sessionId
            });
